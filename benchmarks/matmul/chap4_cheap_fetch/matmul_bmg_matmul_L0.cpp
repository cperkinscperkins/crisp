 ...
 * Source: benchmarks/matmul/chap4_cheap_fetch/matmul_bmg_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/chap4_cheap_fetch/matmul_bmg.spv";
