 ...
 * Source: /workspace/benchmarks/matmul/sec2_top_fp16/matmul_bmg_fp16_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
...
int main() {
    ...
    for (size_t _i = 0; _i < 67108864; _i++) a_ptr[_i] = crisp_f32_to_f16((float)(_i % 5));
    // Arg 0: a PTR
    ...
    for (size_t _i = 0; _i < 67108864; _i++) b_ptr[_i] = crisp_f32_to_f16((float)(_i % 3));
    // Arg 9: b PTR
