/*
 * OneMKL Half (fp16) Optimal reference for SYCL (Intel Ceiling).
 * Uses oneapi::mkl::blas::row_major::gemm with fp16_t inputs and float output.
 *
 * Build: icpx -fsycl -O3 onemkl_fp16.cpp -qmkl -o onemkl_fp16
 */
