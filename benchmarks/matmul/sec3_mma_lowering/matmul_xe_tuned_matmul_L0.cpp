 ...
 * Source: benchmarks/matmul/sec3_mma_lowering/matmul_xe_tuned_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
 *   g++ -o launcher matmul_xe_tuned_matmul_L0.cpp -I<path-to-level-zero>/include -lze_loader
 *
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/sec3_mma_lowering/matmul_xe_tuned.spv";
