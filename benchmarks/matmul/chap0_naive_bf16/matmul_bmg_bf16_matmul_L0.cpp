 ...
 * Source: benchmarks/matmul/chap0_naive_bf16/matmul_bmg_bf16_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/chap0_naive_bf16/matmul_bmg_bf16.spv";
