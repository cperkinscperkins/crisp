/*
 * Hand-written SYCL reference matmul: C[M x N] = A[M x K] . B[K x N].
 * Hand-written 16x16 shared-memory tiled fp32 kernel.
 * Section 1 Chapter 2 Control baseline for Intel.
 *
