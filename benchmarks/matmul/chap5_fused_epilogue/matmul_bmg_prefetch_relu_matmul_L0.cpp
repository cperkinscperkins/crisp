 ...
 * Source: /workspace/benchmarks/matmul/chap5_fused_epilogue/matmul_bmg_prefetch_relu_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/chap5_fused_epilogue/matmul_bmg_prefetch_relu.spv";
