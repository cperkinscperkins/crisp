 ...
 * Source: /workspace/benchmarks/matmul/chap0_naive/matmul_bmg_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/chap0_naive/matmul_bmg.spv";
    ...
    result = zeKernelSetGroupSize(kernel, 16, 16, 1);
    if (result != ZE_RESULT_SUCCESS) {
    ...
    ze_group_count_t groupCount = { ((uint32_t)c_length + 15) / 16, 1, 1 };
