 ...
 * Source: /workspace/benchmarks/matmul/chap5_multistage_ring/matmul_bmg_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/chap5_multistage_ring/matmul_bmg.spv";
