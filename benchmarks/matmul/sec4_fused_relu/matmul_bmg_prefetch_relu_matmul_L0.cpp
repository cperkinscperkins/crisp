 ...
 * Source: /workspace/benchmarks/matmul/sec4_fused_relu/matmul_bmg_prefetch_relu_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
 *   g++ -o launcher matmul_bmg_prefetch_relu_matmul_L0.cpp -I<path-to-level-zero>/include -lze_loader
 *
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/sec4_fused_relu/matmul_bmg_prefetch_relu.spv";
