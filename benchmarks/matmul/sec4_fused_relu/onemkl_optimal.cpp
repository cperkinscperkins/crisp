/*
 * Chapter 5 (Endeavor 150) — INTEL CEILING for a matmul WITH AN ACTIVATION.
 *
 * oneMKL GEMM followed by a SEPARATE ReLU kernel over C.  This is the baseline the fused
