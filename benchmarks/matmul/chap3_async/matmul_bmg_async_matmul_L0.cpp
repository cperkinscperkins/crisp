 ...
 * Source: benchmarks/matmul/chap3_async/matmul_bmg_async_matmul.metacrisp
 * Kernel: matmul
 *
 * Compilation:
 *   g++ -o launcher matmul_bmg_async_matmul_L0.cpp -I<path-to-level-zero>/include -lze_loader
 *
...
int main() {
    ...
    // Load SPIR-V module
    const char* spv_path = "/workspace/benchmarks/matmul/chap3_async/matmul_bmg_async.spv";
