...
|---|---|---|
| Intel BMG | 2026-08-25 | Crisp `f7de8ea` (docker) |
...
|---|---|---|---|---|---|---|---|---|
| 0 | naive loops, no XMX | 0.1 | 0.4 | 1.4 | 1.4 | 0.3 | 1.3 | — |
| 1 | hand-rolled XMX coop-matrix | 0.1 | 0.4 | 1.4 | 1.4 | 1.5 | 0.7 | — |
| 2 | matrix-multiply-tile-stride | 0.1 | 0.4 | 1.4 | 1.4 | 1.5 | 1.3 | — |
| 3 | OpGroupAsyncCopy | 0.1 | 0.2 | 0.8 | 0.8 | 0.7 | 0.7 | — |
| 4 | register-resident load (global→GRF) | 2.9 | 12.1 | 26.0 | 16.3 | 13.1 | — | — |
| 5 | register ring + prefetch | 3.0 | 9.6 | 21.5 | 24.2 | 16.6 | 11.7 | — |
...
| 512 | 0.4 (0.692) | 0.6 (0.450) | 0.65× |
| 1024 | 1.4 (1.587) | 0.7 (3.178) | **2.00×** |
| 2048 | 1.4 (12.059) | 0.4 (39.643) | **3.29×** |
| 4096 | 0.3 (500.078) | 0.3 (523.508) | 1.05× |
...
| 512 | 0.4 (0.694) | 0.5 (0.508) | 0.73× | 1.00× |
| 1024 | 1.4 (1.577) | 1.9 (1.141) | 0.72× | 1.01× |
| 2048 | 1.4 (12.577) | 1.6 (10.846) | 0.86× | 0.96× |
| 4096 | 1.5 (93.483) | 1.7 (79.174) | 0.85× | **5.35×** |
...
| 1024 | 1.4 (1.587) | 1.5 (1.403) | 0.88× | 0.99× |
| 2048 | 1.4 (12.059) | 1.4 (12.251) | 1.02× | 1.04× |
| 4096 | 1.5 (92.395) | 1.3 (105.788) | 1.14× | 1.01× |
...
| 1024 | 0.8 (2.776) | 1.5 (1.402) | 0.51× | 0.57× |
| 2048 | 0.8 (21.353) | 1.4 (12.249) | 0.57× | 0.56× |
| 4096 | 0.7 (186.632) | 1.3 (105.069) | 0.56× | 0.50× |
| 8192 | 0.7 (1475.660) | 1.3 (845.016) | 0.57× | 0.56× |
| 16384 | — | — | — | — |
...
| 512 | 12.1 (0.022) | 13.2 (0.020) | 0.92× | **49.21×** |
| 1024 | 26.0 (0.083) | 28.7 (0.075) | 0.91× | **33.58×** |
| 2048 | 16.3 (1.051) | 20.0 (0.861) | 0.82× | **20.31×** |
| 4096 | 13.1 (10.505) | 20.2 (6.795) | 0.65× | **17.77×** |
| 8192 | — | — | — | — |
| 16384 | — | — | — | — |
...
| 512 | 9.6 (0.028) | 5.1 (0.052) | **1.87×** | 0.79× |
| 1024 | 21.5 (0.100) | 10.2 (0.211) | **2.12×** | 0.83× |
| 2048 | 24.2 (0.711) | 11.1 (1.543) | **2.17×** | 1.48× |
| 4096 | 16.6 (8.296) | 9.5 (14.479) | **1.75×** | 1.27× |
...
| 2048 | 24.7 (0.696) | 11.3 (1.527) | **2.19×** | 1.02× |
| 4096 | 15.8 (8.719) | 9.6 (14.386) | **1.65×** | 0.95× |
...
|---|---:|---:|---:|---:|
| Ch 0 naive (no XMX) | — | — | — | 0.3 (1.00×) |
| Ch 1 hand-rolled MMA | 0.8 (**2.19×**) | 2.3 (1.72×) | 2.4 (1.76×) | 2.1 (1.41×) |
| Ch 2 tiling macro | — | — | — | 2.1 (tf32 n/a) |
