...
|---|---|---|
| Intel BMG | 2026-08-23 | Crisp `878b3af` (docker) |
...
|---:|---:|---:|---:|---:|---:|---:|
| 256 | 3.8 (0.009) | 2.0 (0.017) | 0.4 (0.088) | 9.8 (0.003) | **10.00×** | 39% |
| 512 | 17.0 (0.016) | 7.5 (0.036) | 3.5 (0.076) | 41.0 (0.007) | **4.80×** | 41% |
| 1024 | 50.0 (0.043) | 15.3 (0.141) | 26.5 (0.081) | 75.1 (0.029) | **1.88×** | 67% |
| 2048 | 60.9 (0.282) | 17.6 (0.974) | 91.4 (0.188) | 87.4 (0.196) | 0.67× | 70% |
| 4096 | 56.8 (2.421) | 17.9 (7.699) | 188.8 (0.728) | 104.9 (1.310) | 0.30× | 54% |
| 8192 | 40.1 (27.435) | 15.2 (72.120) | 230.7 (4.766) | 112.9 (9.737) | 0.17× | 35% |
| 16384 | — | 11.0 (798.582) | 252.5 (34.834) | 114.5 (76.834) | — | — |
...
|---|---|---:|---:|---:|
| **Crisp** | Crisp | 743 ms | 1.55 s | 0.41× |
| **SYCL_Apples_BF16** | Control | 1.81 s | 4.80 s | 1.00× |
| **SYCL-TLA_BF16** | Peer | 29.47 s | 54.99 s | **16.3× slower** |
| **oneMKL_BF16** | Ceiling | *precompiled* | 7.14 s | — |
...
| 1024 | 49.5 (0.043) | 15.3 (0.141) | — | 75.1 (0.029) | — | 66% |
| 2048 | 61.1 (0.281) | 17.6 (0.974) | — | 87.4 (0.197) | — | 70% |
| 4096 | 57.1 (2.408) | 17.8 (7.720) | — | 110.8 (1.240) | — | 51% |
| 8192 | 40.4 (27.248) | 15.2 (72.208) | — | 111.6 (9.852) | — | 36% |
...
| contender | class | device codegen (SPIR-V) | total build | **vs Control codegen** |
|---|---|---:|---:|---:|
| **Crisp** | Crisp | 669 ms | 1.51 s | 0.36× |
...
| 2026-08-23 19:44 | matmul | sec2_top_bf16 | Crisp | `256,512,1024,2048,4096,8192` |
| 2026-08-23 19:45 | matmul | sec2_top_bf16 | SYCL_Apples_BF16 | `256,512,1024,2048,4096,8192,16384` |
| 2026-08-23 19:46 | matmul | sec2_top_bf16 | SYCL-TLA_BF16 | `256,512,1024,2048,4096,8192,16384` |
| 2026-08-23 19:46 | matmul | sec2_top_bf16 | OneMKL_BF16 | `256,512,1024,2048,4096,8192,16384` |
| 2026-08-23 19:47 | matmul | sec2_top_fp16 | Crisp | `256,512,1024,2048,4096,8192` |
| 2026-08-23 19:47 | matmul | sec2_top_fp16 | SYCL_Apples_FP16 | `256,512,1024,2048,4096,8192,16384` |
| 2026-08-23 19:47 | matmul | sec2_top_fp16 | OneMKL_FP16 | `256,512,1024,2048,4096,8192,16384` |