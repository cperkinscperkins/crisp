...
|---|---|---|
| Intel BMG | 2026-08-23 | Crisp `72ea32d` (docker) |
...
|---:|---:|---:|---:|---:|---:|---:|
| 256 | 4.8 (0.007) | 2.0 (0.017) | 0.4 (0.086) | 9.8 (0.003) | **12.38×** | 49% |
| 512 | 15.8 (0.017) | 7.5 (0.036) | 3.5 (0.076) | 41.0 (0.007) | **4.46×** | 39% |
| 1024 | 39.8 (0.054) | 15.3 (0.141) | 26.9 (0.080) | 75.1 (0.029) | 1.48× | 53% |
| 2048 | 40.5 (0.424) | 17.6 (0.975) | 83.3 (0.206) | 89.2 (0.193) | 0.49× | 45% |
| 4096 | 34.9 (3.940) | 17.8 (7.714) | 192.9 (0.712) | 105.0 (1.309) | 0.18× | 33% |
| 8192 | 27.4 (40.118) | 15.3 (72.066) | 236.6 (4.647) | 113.0 (9.734) | 0.12× | 24% |
| 16384 | — | 10.9 (807.146) | 249.3 (35.285) | 115.2 (76.346) | — | — |
...
|---|---|---:|---:|---:|
| **Crisp** | Crisp | 927 ms | 1.76 s | 0.50× |
| **SYCL_Apples_BF16** | Control | 1.85 s | 4.22 s | 1.00× |
| **SYCL-TLA_BF16** | Peer | 31.88 s | 58.44 s | **17.3× slower** |
| **oneMKL_BF16** | Ceiling | *precompiled* | 7.31 s | — |
...
| 2026-08-23 18:44 | matmul | sec2_top_bf16 | Crisp | `256,512,1024,2048,4096,8192` |
| 2026-08-23 18:44 | matmul | sec2_top_bf16 | SYCL_Apples_BF16 | `256,512,1024,2048,4096,8192,16384` |
| 2026-08-23 18:46 | matmul | sec2_top_bf16 | SYCL-TLA_BF16 | `256,512,1024,2048,4096,8192,16384` |
| 2026-08-23 18:46 | matmul | sec2_top_bf16 | OneMKL_BF16 | `256,512,1024,2048,4096,8192,16384` |