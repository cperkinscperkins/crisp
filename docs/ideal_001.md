...
> NOTE: revisit the above assertion about "only" flags. We have added some, like --denormal-handling. Why are most flags ignored anyway? The destination and target ones make sense to skip. What about --debug ?
