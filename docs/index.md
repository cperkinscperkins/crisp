...
- [def-type-function](chapters/08_crisp_types/17_def_type_function.md)
...
- [General Purpose: `tensor-stride`, `grid-stride`,  `tile-stride` and `hardware-stride`](chapters/14_control_flow/11_general_purpose_tensor_stride_grid_stride_tile_stride_and_hardware_stride.md)
- [Load Tile / Store Tile](chapters/14_control_flow/12_load_tile_store_tile.md)
- [workgroup-stride](chapters/14_control_flow/13_workgroup_stride.md)
- [Workgroup Stride](chapters/14_control_flow/14_workgroup_stride.md)
- [Looping -- Uniform Loops](chapters/14_control_flow/15_looping_uniform_loops.md)
- [Looping Constructs](chapters/14_control_flow/16_looping_constructs.md)
- [Grid Level Operations](chapters/14_control_flow/17_grid_level_operations.md)
- [Workgroup Level Operations](chapters/14_control_flow/18_workgroup_level_operations.md)
- [Barriers and Fences](chapters/14_control_flow/19_barriers_and_fences.md)
- [Sum a Vector using Local Memory](chapters/14_control_flow/20_sum_a_vector_using_local_memory.md)
- [Warps & Shuffles](chapters/14_control_flow/21_warps_shuffles.md)
- [Sum a Vector using Warps and Shuffles](chapters/14_control_flow/22_sum_a_vector_using_warps_and_shuffles.md)
...
## Static Analysys
- [declaim](chapters/43_static_analysys/01_declaim.md)
- [check-coalesce](chapters/43_static_analysys/02_check_coalesce.md)
- [check-bank-conflicts](chapters/43_static_analysys/03_check_bank_conflicts.md)
- [check-divergence](chapters/43_static_analysys/04_check_divergence.md)
- [max-registers / warn-max-registers](chapters/43_static_analysys/05_max_registers_warn_max_registers.md)
- [check-barriers](chapters/43_static_analysys/06_check_barriers.md)
- [miscellaneous](chapters/43_static_analysys/07_miscellaneous.md)

## Auto Differentiation (AD)
- [`--differentiate`](chapters/44_auto_differentiation_ad/01__differentiate.md)

## Hoisting and `def-orchestration`
- [`def-orchestration`](chapters/45_hoisting_and_def_orchestration/01_def_orchestration.md)
- [launch-sequential](chapters/45_hoisting_and_def_orchestration/02_launch_sequential.md)
- [launch-kernel](chapters/45_hoisting_and_def_orchestration/03_launch_kernel.md)
- [launch-parallel](chapters/45_hoisting_and_def_orchestration/04_launch_parallel.md)
- [launch-interleaved](chapters/45_hoisting_and_def_orchestration/05_launch_interleaved.md)

## Compiler Invocation and Options
- [Output Targeting Options](chapters/46_compiler_invocation_and_options/01_output_targeting_options.md)
- [Other Flags](chapters/46_compiler_invocation_and_options/02_other_flags.md)
- [Compiliation Flags](chapters/46_compiler_invocation_and_options/03_compiliation_flags.md)
- [Fast Compilation](chapters/46_compiler_invocation_and_options/04_fast_compilation.md)
- [Compiler Invocations and Files](chapters/46_compiler_invocation_and_options/05_compiler_invocations_and_files.md)

## Hoisting Code

## In-Memory Compilation API
- [C API](chapters/48_in_memory_compilation_api/01_c_api.md)
- [Status Codes](chapters/48_in_memory_compilation_api/02_status_codes.md)
- [Flags](chapters/48_in_memory_compilation_api/03_flags.md)

## APPENDIX #1 - Summary: set / get vars, storage handles, and structs

## APPENDIX #2 - Math with Quantized Ints and Microfloat
- [dot product and matmul](chapters/50_appendix_2_math_with_quantized_ints_and_microfloat/01_dot_product_and_matmul.md)

## Acknowledgements

## INDECES
- [def-](chapters/52_indeces/01_def_.md)
- [control flow](chapters/52_indeces/02_control_flow.md)
- [Higher Order Function Operations](chapters/52_indeces/03_higher_order_function_operations.md)
- [Sorting](chapters/52_indeces/04_sorting.md)
- [Algorithms](chapters/52_indeces/05_algorithms.md)
- [Atomics](chapters/52_indeces/06_atomics.md)
- [Type Constraints](chapters/52_indeces/07_type_constraints.md)
- [other](chapters/52_indeces/08_other.md)
- [Hardware Operations](chapters/52_indeces/09_hardware_operations.md)
- [logging and debugging](chapters/52_indeces/10_logging_and_debugging.md)
- [static analysis](chapters/52_indeces/11_static_analysis.md)
- [hoisting and def-orchestration](chapters/52_indeces/12_hoisting_and_def_orchestration.md)
- [lisp](chapters/52_indeces/13_lisp.md)
- [To Do](chapters/52_indeces/14_to_do.md)
- [Memory](chapters/52_indeces/15_memory.md)
