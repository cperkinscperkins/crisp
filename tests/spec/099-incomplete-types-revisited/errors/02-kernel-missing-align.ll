; ModuleID = '02-kernel-missing-align'
source_filename = "02-kernel-missing-align"
...
define void @kernel_missing_align(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, ptr addrspace(1) %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12) {
entry:
  ...
  %idx25 = load i64, ptr %idx, align 4
  %a26 = load %TENSOR_FLOAT_1_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val = extractvalue %TENSOR_FLOAT_1_GLOBAL_COMPACT_LAST %a26, 0
  %t_base_ptr = extractvalue %STORAGE_GLOBAL %t_parent_val, 0
  %t_byte_off = mul i64 %idx25, ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64)
  ...
  %idx27 = load i64, ptr %idx, align 4
  %c28 = load %TENSOR_FLOAT_1_GLOBAL_COMPACT_LAST, ptr %c, align 8
  %t_parent_val29 = extractvalue %TENSOR_FLOAT_1_GLOBAL_COMPACT_LAST %c28, 0
  %t_base_ptr30 = extractvalue %STORAGE_GLOBAL %t_parent_val29, 0
  %t_byte_off31 = mul i64 %idx27, ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64)
  %t_ptr_i832 = getelementptr inbounds i8, ptr addrspace(1) %t_base_ptr30, i64 %t_byte_off31
  %t_elem33 = load float, ptr addrspace(1) %t_ptr_i832, align 4
  store float %t_elem, ptr addrspace(1) %t_ptr_i832, align 4
  ret void
}
