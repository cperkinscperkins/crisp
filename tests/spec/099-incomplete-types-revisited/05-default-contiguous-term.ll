; ModuleID = '05-default-contiguous-term'
source_filename = "05-default-contiguous-term"
...
define float @read_at_defaulted_ct_tensor_float_1_global_compact_last_ulong(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6) {
entry:
  %ADDRESS_ins = insertvalue %STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %TENSOR_FLOAT_1_GLOBAL_COMPACT_LAST undef, %STORAGE_GLOBAL %BYTE-SIZE_ins, 0
...
define void @default_ct_test(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, ptr addrspace(1) %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12) {
entry:
  ...
  %call_tmp = call float @read_at_defaulted_ct_tensor_float_1_global_compact_last_ulong(ptr addrspace(1) %ADDRESS_val, i64 %BYTE-SIZE_val, i64 %arr_elem_0, i64 %arr_elem_026, i64 %arr_elem_027, i64 %LENGTH_val, i64 %idx28)
