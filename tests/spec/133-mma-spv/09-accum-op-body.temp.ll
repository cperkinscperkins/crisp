; ModuleID = '09-accum-op-body'
source_filename = "09-accum-op-body"
target triple = "spir64-unknown-unknown"

%S_09_accum_op_body_STORAGE_GLOBAL = type { ptr addrspace(1), i64 }
%S_09_accum_op_body_CELL_INT_GLOBAL = type { %S_09_accum_op_body_STORAGE_GLOBAL, i64 }
%S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST = type { %S_09_accum_op_body_STORAGE_GLOBAL, [2 x i64], [2 x i64], [2 x i64], i64 }
%S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST = type { %S_09_accum_op_body_STORAGE_GLOBAL, [2 x i64], [2 x i64], [2 x i64], i64 }
%S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 = type { float, float, float, float }
%S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 = type { float, float, float, float }
%S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 = type { float, float }
...
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %obj = alloca %S_09_accum_op_body_STORAGE_GLOBAL, align 8
  store %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, ptr %obj, align 8
  %obj1 = load %S_09_accum_op_body_STORAGE_GLOBAL, ptr %obj, align 8
  %extract_0 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %obj1, 0
...
entry:
  ...
  store %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, ptr %obj, align 8
  %obj1 = load %S_09_accum_op_body_STORAGE_GLOBAL, ptr %obj, align 8
  %extract_1 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %obj1, 1
  ret i64 %extract_1
}
...
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @parent__cell_int_global(ptr addrspace(1) %0, i64 %1, i64 %2) #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %S_09_accum_op_body_CELL_INT_GLOBAL undef, %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, 0
  %OFFSET_ins = insertvalue %S_09_accum_op_body_CELL_INT_GLOBAL %PARENT_ins, i64 %2, 1
  %obj = alloca %S_09_accum_op_body_CELL_INT_GLOBAL, align 8
  store %S_09_accum_op_body_CELL_INT_GLOBAL %OFFSET_ins, ptr %obj, align 8
  %obj1 = load %S_09_accum_op_body_CELL_INT_GLOBAL, ptr %obj, align 8
  %extract_0 = extractvalue %S_09_accum_op_body_CELL_INT_GLOBAL %obj1, 0
  ret %S_09_accum_op_body_STORAGE_GLOBAL %extract_0
}
...
entry:
  ...
  store %S_09_accum_op_body_CELL_INT_GLOBAL %OFFSET_ins, ptr %obj, align 8
  %obj1 = load %S_09_accum_op_body_CELL_INT_GLOBAL, ptr %obj, align 8
  %extract_1 = extractvalue %S_09_accum_op_body_CELL_INT_GLOBAL %obj1, 1
  ret i64 %extract_1
}
...
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @_parent__cell_int_global(ptr addrspace(1) %0, i64 %1, i64 %2) #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %S_09_accum_op_body_CELL_INT_GLOBAL undef, %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, 0
...
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @parent__tensor_float_2_global_compact_last(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST undef, %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, 0
  %arr_build_0 = insertvalue [2 x i64] undef, i64 %2, 0
  %arr_build_1 = insertvalue [2 x i64] %arr_build_0, i64 %3, 1
  %OFFSET_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %PARENT_ins, [2 x i64] %arr_build_1, 1
  %arr_build_01 = insertvalue [2 x i64] undef, i64 %4, 0
  %arr_build_12 = insertvalue [2 x i64] %arr_build_01, i64 %5, 1
  %STRIDES_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %OFFSET_ins, [2 x i64] %arr_build_12, 2
  %arr_build_03 = insertvalue [2 x i64] undef, i64 %6, 0
  %arr_build_14 = insertvalue [2 x i64] %arr_build_03, i64 %7, 1
  %EXTENTS_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %STRIDES_ins, [2 x i64] %arr_build_14, 3
  %LENGTH_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %EXTENTS_ins, i64 %8, 4
  %obj = alloca %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, align 8
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %LENGTH_ins, ptr %obj, align 8
  %obj5 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %obj, align 8
  %extract_0 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %obj5, 0
  ret %S_09_accum_op_body_STORAGE_GLOBAL %extract_0
}
...
entry:
  ...
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %LENGTH_ins, ptr %obj, align 8
  %obj5 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %obj, align 8
  %extract_4 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %obj5, 4
  ret i64 %extract_4
}
...
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @_parent__tensor_float_2_global_compact_last(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST undef, %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, 0
...
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @parent__tensor_float_2_global_compact_first(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST undef, %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, 0
  %arr_build_0 = insertvalue [2 x i64] undef, i64 %2, 0
  %arr_build_1 = insertvalue [2 x i64] %arr_build_0, i64 %3, 1
  %OFFSET_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %PARENT_ins, [2 x i64] %arr_build_1, 1
  %arr_build_01 = insertvalue [2 x i64] undef, i64 %4, 0
  %arr_build_12 = insertvalue [2 x i64] %arr_build_01, i64 %5, 1
  %STRIDES_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %OFFSET_ins, [2 x i64] %arr_build_12, 2
  %arr_build_03 = insertvalue [2 x i64] undef, i64 %6, 0
  %arr_build_14 = insertvalue [2 x i64] %arr_build_03, i64 %7, 1
  %EXTENTS_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %STRIDES_ins, [2 x i64] %arr_build_14, 3
  %LENGTH_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %EXTENTS_ins, i64 %8, 4
  %obj = alloca %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, align 8
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %LENGTH_ins, ptr %obj, align 8
  %obj5 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %obj, align 8
  %extract_0 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %obj5, 0
  ret %S_09_accum_op_body_STORAGE_GLOBAL %extract_0
}
...
entry:
  ...
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %LENGTH_ins, ptr %obj, align 8
  %obj5 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %obj, align 8
  %extract_4 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %obj5, 4
  ret i64 %extract_4
}
...
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @_parent__tensor_float_2_global_compact_first(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  %PARENT_ins = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST undef, %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins, 0
...
entry:
  ...
  %insert_ADDRESS = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %a_ptr1, 0
  %a_byte_size2 = load i64, ptr %a_byte_size, align 4
  %insert_BYTE-SIZE = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %insert_ADDRESS, i64 %a_byte_size2, 1
  %insert_PARENT = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST undef, %S_09_accum_op_body_STORAGE_GLOBAL %insert_BYTE-SIZE, 0
  ...
  %insert_OFFSET = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_PARENT, [2 x i64] %arr_ins_1, 1
  ...
  %insert_STRIDES = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_OFFSET, [2 x i64] %arr_ins_18, 2
  ...
  %insert_EXTENTS = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_STRIDES, [2 x i64] %arr_ins_112, 3
  %a_length13 = load i64, ptr %a_length, align 4
  %insert_LENGTH = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_EXTENTS, i64 %a_length13, 4
  %a = alloca %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, align 8
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_LENGTH, ptr %a, align 8
  %b_ptr14 = load ptr addrspace(1), ptr %b_ptr, align 8
  %insert_ADDRESS15 = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %b_ptr14, 0
  %b_byte_size16 = load i64, ptr %b_byte_size, align 4
  %insert_BYTE-SIZE17 = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %insert_ADDRESS15, i64 %b_byte_size16, 1
  %insert_PARENT18 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST undef, %S_09_accum_op_body_STORAGE_GLOBAL %insert_BYTE-SIZE17, 0
  ...
  %insert_OFFSET23 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %insert_PARENT18, [2 x i64] %arr_ins_122, 1
  ...
  %insert_STRIDES28 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %insert_OFFSET23, [2 x i64] %arr_ins_127, 2
  ...
  %insert_EXTENTS33 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %insert_STRIDES28, [2 x i64] %arr_ins_132, 3
  %b_length34 = load i64, ptr %b_length, align 4
  %insert_LENGTH35 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %insert_EXTENTS33, i64 %b_length34, 4
  %b = alloca %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, align 8
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %insert_LENGTH35, ptr %b, align 8
  %c_ptr36 = load ptr addrspace(1), ptr %c_ptr, align 8
  %insert_ADDRESS37 = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %c_ptr36, 0
  %c_byte_size38 = load i64, ptr %c_byte_size, align 4
  %insert_BYTE-SIZE39 = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %insert_ADDRESS37, i64 %c_byte_size38, 1
  %insert_PARENT40 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST undef, %S_09_accum_op_body_STORAGE_GLOBAL %insert_BYTE-SIZE39, 0
  ...
  %insert_OFFSET45 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_PARENT40, [2 x i64] %arr_ins_144, 1
  ...
  %insert_STRIDES50 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_OFFSET45, [2 x i64] %arr_ins_149, 2
  ...
  %insert_EXTENTS55 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_STRIDES50, [2 x i64] %arr_ins_154, 3
  %c_length56 = load i64, ptr %c_length, align 4
  %insert_LENGTH57 = insertvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_EXTENTS55, i64 %c_length56, 4
  %c = alloca %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, align 8
  store %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %insert_LENGTH57, ptr %c, align 8
  %"c-tile$f0" = alloca %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, align 8
  store %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 zeroinitializer, ptr %"c-tile$f0", align 4
  %"c-tile$f058" = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %"c-tile$f0", align 4
  ...
  %mod-x410 = alloca i32, align 4
  store i32 %lane60, ptr %mod-x410, align 4
  %mod-y411 = alloca i32, align 4
  store i32 4, ptr %mod-y411, align 4
  %mod-x41061 = load i32, ptr %mod-x410, align 4
  %mod-x41062 = load i32, ptr %mod-x410, align 4
  %mod-y41163 = load i32, ptr %mod-y411, align 4
  %iop_tmp64 = sdiv i32 %mod-x41062, %mod-y41163
  %mod-y41165 = load i32, ptr %mod-y411, align 4
  %iop_tmp66 = mul i32 %iop_tmp64, %mod-y41165
  %iop_tmp67 = sub i32 %mod-x41061, %iop_tmp66
  ...
  %arr_field_ptr = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a78 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a78, 0
  %t_base_ptr = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val, 0
  ...
  %insert_A0 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 undef, float %t_elem, 0
  %r79 = load i32, ptr %r, align 4
  %iop_tmp80 = add i32 %r79, 8
  %sext_cast81 = sext i32 %iop_tmp80 to i64
  %arr_field_ptr82 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a89 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val90 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a89, 0
  %t_base_ptr91 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val90, 0
  ...
  %insert_A1 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A0, float %t_elem94, 1
  %r95 = load i32, ptr %r, align 4
  %sext_cast96 = sext i32 %r95 to i64
  %arr_field_ptr97 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a105 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val106 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a105, 0
  %t_base_ptr107 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val106, 0
  ...
  %insert_A2 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A1, float %t_elem110, 2
  %r111 = load i32, ptr %r, align 4
  %iop_tmp112 = add i32 %r111, 8
  %sext_cast113 = sext i32 %iop_tmp112 to i64
  %arr_field_ptr114 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a122 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val123 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a122, 0
  %t_base_ptr124 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val123, 0
  ...
  %insert_A3 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A2, float %t_elem127, 3
  ...
  %mod-x412 = alloca i32, align 4
  store i32 %lane133, ptr %mod-x412, align 4
  %mod-y413 = alloca i32, align 4
  store i32 4, ptr %mod-y413, align 4
  %mod-x412134 = load i32, ptr %mod-x412, align 4
  %mod-x412135 = load i32, ptr %mod-x412, align 4
  %mod-y413136 = load i32, ptr %mod-y413, align 4
  %iop_tmp137 = sdiv i32 %mod-x412135, %mod-y413136
  %mod-y413138 = load i32, ptr %mod-y413, align 4
  %iop_tmp139 = mul i32 %iop_tmp137, %mod-y413138
  %iop_tmp140 = sub i32 %mod-x412134, %iop_tmp139
  ...
  %arr_field_ptr150 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, i32 0, i32 3
  ...
  %b157 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, align 8
  %t_parent_val158 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %b157, 0
  %t_base_ptr159 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val158, 0
  ...
  %insert_B0 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 undef, float %t_elem162, 0
  %r163 = load i32, ptr %r144, align 4
  %iop_tmp164 = add i32 %r163, 4
  %sext_cast165 = sext i32 %iop_tmp164 to i64
  %arr_field_ptr166 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, i32 0, i32 3
  ...
  %b173 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, align 8
  %t_parent_val174 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %b173, 0
  %t_base_ptr175 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val174, 0
  ...
  %insert_B1 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 %insert_B0, float %t_elem178, 1
  %a0 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3, 0
  %a0i = bitcast float %a0 to i32
  %a1 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3, 1
  %a1i = bitcast float %a1 to i32
  %a2 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3, 2
  %a2i = bitcast float %a2 to i32
  %a3 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3, 3
  %a3i = bitcast float %a3 to i32
  %b0 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 %insert_B1, 0
  %b0i = bitcast float %b0 to i32
  %b1 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 %insert_B1, 1
  %b1i = bitcast float %b1 to i32
  %c0 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f058", 0
  %c1 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f058", 1
  %c2 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f058", 2
  %c3 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f058", 3
  ...
  %acc0 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 undef, float %d0, 0
  %d1 = extractvalue { float, float, float, float } %mma, 1
  %acc1 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc0, float %d1, 1
  %d2 = extractvalue { float, float, float, float } %mma, 2
  %acc2 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc1, float %d2, 2
  %d3 = extractvalue { float, float, float, float } %mma, 3
  %acc3 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc2, float %d3, 3
  store %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc3, ptr %"c-tile$f0", align 4
  %"c-tile$f0179" = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %"c-tile$f0", align 4
  ...
  %mod-x414 = alloca i32, align 4
  store i32 %lane185, ptr %mod-x414, align 4
  %mod-y415 = alloca i32, align 4
  store i32 4, ptr %mod-y415, align 4
  %mod-x414186 = load i32, ptr %mod-x414, align 4
  %mod-x414187 = load i32, ptr %mod-x414, align 4
  %mod-y415188 = load i32, ptr %mod-y415, align 4
  %iop_tmp189 = sdiv i32 %mod-x414187, %mod-y415188
  %mod-y415190 = load i32, ptr %mod-y415, align 4
  %iop_tmp191 = mul i32 %iop_tmp189, %mod-y415190
  %iop_tmp192 = sub i32 %mod-x414186, %iop_tmp191
  ...
  %arr_field_ptr202 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a209 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val210 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a209, 0
  %t_base_ptr211 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val210, 0
  ...
  %insert_A0215 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 undef, float %t_elem214, 0
  %r216 = load i32, ptr %r196, align 4
  %iop_tmp217 = add i32 %r216, 8
  %sext_cast218 = sext i32 %iop_tmp217 to i64
  %arr_field_ptr219 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a226 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val227 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a226, 0
  %t_base_ptr228 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val227, 0
  ...
  %insert_A1232 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A0215, float %t_elem231, 1
  %r233 = load i32, ptr %r196, align 4
  %sext_cast234 = sext i32 %r233 to i64
  %arr_field_ptr235 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a243 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val244 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a243, 0
  %t_base_ptr245 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val244, 0
  ...
  %insert_A2249 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A1232, float %t_elem248, 2
  %r250 = load i32, ptr %r196, align 4
  %iop_tmp251 = add i32 %r250, 8
  %sext_cast252 = sext i32 %iop_tmp251 to i64
  %arr_field_ptr253 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, i32 0, i32 3
  ...
  %a261 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %a, align 8
  %t_parent_val262 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %a261, 0
  %t_base_ptr263 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val262, 0
  ...
  %insert_A3267 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A2249, float %t_elem266, 3
  ...
  %mod-x416 = alloca i32, align 4
  store i32 %lane273, ptr %mod-x416, align 4
  %mod-y417 = alloca i32, align 4
  store i32 4, ptr %mod-y417, align 4
  %mod-x416274 = load i32, ptr %mod-x416, align 4
  %mod-x416275 = load i32, ptr %mod-x416, align 4
  %mod-y417276 = load i32, ptr %mod-y417, align 4
  %iop_tmp277 = sdiv i32 %mod-x416275, %mod-y417276
  %mod-y417278 = load i32, ptr %mod-y417, align 4
  %iop_tmp279 = mul i32 %iop_tmp277, %mod-y417278
  %iop_tmp280 = sub i32 %mod-x416274, %iop_tmp279
  ...
  %arr_field_ptr290 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, i32 0, i32 3
  ...
  %b297 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, align 8
  %t_parent_val298 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %b297, 0
  %t_base_ptr299 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val298, 0
  ...
  %insert_B0303 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 undef, float %t_elem302, 0
  %r304 = load i32, ptr %r284, align 4
  %iop_tmp305 = add i32 %r304, 4
  %sext_cast306 = sext i32 %iop_tmp305 to i64
  %arr_field_ptr307 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, i32 0, i32 3
  ...
  %b314 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST, ptr %b, align 8
  %t_parent_val315 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_FIRST %b314, 0
  %t_base_ptr316 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val315, 0
  ...
  %insert_B1320 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 %insert_B0303, float %t_elem319, 1
  %a0321 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3267, 0
  %a0i322 = bitcast float %a0321 to i32
  %a1323 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3267, 1
  %a1i324 = bitcast float %a1323 to i32
  %a2325 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3267, 2
  %a2i326 = bitcast float %a2325 to i32
  %a3327 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-A-TF32-16X8 %insert_A3267, 3
  %a3i328 = bitcast float %a3327 to i32
  %b0329 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 %insert_B1320, 0
  %b0i330 = bitcast float %b0329 to i32
  %b1331 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-B-TF32-8X8 %insert_B1320, 1
  %b1i332 = bitcast float %b1331 to i32
  %c0333 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f0179", 0
  %c1334 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f0179", 1
  %c2335 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f0179", 2
  %c3336 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f0179", 3
  ...
  %acc0339 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 undef, float %d0338, 0
  %d1340 = extractvalue { float, float, float, float } %mma337, 1
  %acc1341 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc0339, float %d1340, 1
  %d2342 = extractvalue { float, float, float, float } %mma337, 2
  %acc2343 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc1341, float %d2342, 2
  %d3344 = extractvalue { float, float, float, float } %mma337, 3
  %acc3345 = insertvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc2343, float %d3344, 3
  store %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %acc3345, ptr %"c-tile$f0", align 4
  %"c-tile$f0346" = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %"c-tile$f0", align 4
  %frag-val = alloca %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, align 8
  store %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %"c-tile$f0346", ptr %frag-val, align 4
  ...
  %mod-x418 = alloca i32, align 4
  store i32 %lane352, ptr %mod-x418, align 4
  %mod-y419 = alloca i32, align 4
  store i32 4, ptr %mod-y419, align 4
  %mod-x418353 = load i32, ptr %mod-x418, align 4
  %mod-x418354 = load i32, ptr %mod-x418, align 4
  %mod-y419355 = load i32, ptr %mod-y419, align 4
  %iop_tmp356 = sdiv i32 %mod-x418354, %mod-y419355
  %mod-y419357 = load i32, ptr %mod-y419, align 4
  %iop_tmp358 = mul i32 %iop_tmp356, %mod-y419357
  %iop_tmp359 = sub i32 %mod-x418353, %iop_tmp358
  ...
  %frag-val365 = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %frag-val, align 4
  %extract_0 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %frag-val365, 0
  %row366 = load i32, ptr %row, align 4
  %sext_cast367 = sext i32 %row366 to i64
  %arr_field_ptr368 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, i32 0, i32 3
  ...
  %c375 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, align 8
  %t_parent_val376 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %c375, 0
  %t_base_ptr377 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val376, 0
  ...
  %frag-val381 = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %frag-val, align 4
  %extract_1 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %frag-val381, 1
  %row382 = load i32, ptr %row, align 4
  %sext_cast383 = sext i32 %row382 to i64
  %arr_field_ptr384 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, i32 0, i32 3
  ...
  %c392 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, align 8
  %t_parent_val393 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %c392, 0
  %t_base_ptr394 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val393, 0
  ...
  %frag-val398 = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %frag-val, align 4
  %extract_2 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %frag-val398, 2
  %row399 = load i32, ptr %row, align 4
  %iop_tmp400 = add i32 %row399, 8
  %sext_cast401 = sext i32 %iop_tmp400 to i64
  %arr_field_ptr402 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, i32 0, i32 3
  ...
  %c409 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, align 8
  %t_parent_val410 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %c409, 0
  %t_base_ptr411 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val410, 0
  ...
  %frag-val415 = load %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8, ptr %frag-val, align 4
  %extract_3 = extractvalue %S_09_accum_op_body_REGISTER-FRAGMENT-ACC-F32-16X8 %frag-val415, 3
  %row416 = load i32, ptr %row, align 4
  %iop_tmp417 = add i32 %row416, 8
  %sext_cast418 = sext i32 %iop_tmp417 to i64
  %arr_field_ptr419 = getelementptr inbounds %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, i32 0, i32 3
  ...
  %c427 = load %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST, ptr %c, align 8
  %t_parent_val428 = extractvalue %S_09_accum_op_body_TENSOR_FLOAT_2_GLOBAL_COMPACT_LAST %c427, 0
  %t_base_ptr429 = extractvalue %S_09_accum_op_body_STORAGE_GLOBAL %t_parent_val428, 0
...
!0 = !{ptr @via_tile_body, i32 4459, i32 32}
!1 = !{}
