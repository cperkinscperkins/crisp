; ModuleID = 'C:/Users/cperk/Documents/crisp-man/tests/spec/133-mma-spv/05-mma-via-tile-multi.temp.ll'
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_05_mma_via_tile_multi_STORAGE_GLOBAL @parent__cell_int_global(ptr addrspace(1) %0, i64 %1, i64 %2) local_unnamed_addr #0 {
entry:
  ...
  ret %S_05_mma_via_tile_multi_STORAGE_GLOBAL %BYTE-SIZE_ins
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_05_mma_via_tile_multi_STORAGE_GLOBAL @_parent__cell_int_global(ptr addrspace(1) %0, i64 %1, i64 %2) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_05_mma_via_tile_multi_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_05_mma_via_tile_multi_STORAGE_GLOBAL @parent__tensor_float_2_global_compact_last(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_05_mma_via_tile_multi_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_05_mma_via_tile_multi_STORAGE_GLOBAL @_parent__tensor_float_2_global_compact_last(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_05_mma_via_tile_multi_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_05_mma_via_tile_multi_STORAGE_GLOBAL @parent__tensor_float_2_global_compact_first(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_05_mma_via_tile_multi_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_05_mma_via_tile_multi_STORAGE_GLOBAL @_parent__tensor_float_2_global_compact_first(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_05_mma_via_tile_multi_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_05_mma_via_tile_multi_STORAGE_GLOBAL %BYTE-SIZE_ins
...
entry:
  ...
  %t_elem203 = load i32, ptr addrspace(1) %t_ptr_i8, align 4, !invariant.load !5
  ...
  %t_elem94204 = load i32, ptr addrspace(1) %t_ptr_i893, align 4, !invariant.load !5
  ...
  %t_elem110205 = load i32, ptr addrspace(1) %t_ptr_i8109, align 4, !invariant.load !5
  ...
  %t_elem127206 = load i32, ptr addrspace(1) %t_ptr_i8126, align 4, !invariant.load !5
  ...
  %t_elem162207 = load i32, ptr addrspace(1) %t_ptr_i8161, align 4, !invariant.load !5
  ...
  %t_elem178208 = load i32, ptr addrspace(1) %t_ptr_i8177, align 4, !invariant.load !5
  %mma = tail call { float, float, float, float } @llvm.nvvm.mma.m16n8k8.row.col.tf32(i32 %t_elem203, i32 %t_elem94204, i32 %t_elem110205, i32 %t_elem127206, i32 %t_elem162207, i32 %t_elem178208, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00)
  ...
  %iop_tmp296 = add i64 %iop_tmp153, %sext_cast81
  %t_byte_off300 = shl i64 %iop_tmp296, 2
  %t_ptr_i8301 = getelementptr inbounds i8, ptr addrspace(1) %9, i64 %t_byte_off300
  %t_elem302209 = load i32, ptr addrspace(1) %t_ptr_i8301, align 4, !invariant.load !5
  %iop_tmp313 = add i64 %iop_tmp169, %sext_cast81
  %t_byte_off317 = shl i64 %iop_tmp313, 2
  %t_ptr_i8318 = getelementptr inbounds i8, ptr addrspace(1) %9, i64 %t_byte_off317
  %t_elem319210 = load i32, ptr addrspace(1) %t_ptr_i8318, align 4, !invariant.load !5
  %mma337 = tail call { float, float, float, float } @llvm.nvvm.mma.m16n8k8.row.col.tf32(i32 %t_elem203, i32 %t_elem94204, i32 %t_elem110205, i32 %t_elem127206, i32 %t_elem302209, i32 %t_elem319210, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00)
  ...
  %iop_tmp360 = shl i32 %iop_tmp67, 1
  %iop_tmp371 = mul i64 %25, %sext_cast
  %sext_cast373 = sext i32 %iop_tmp360 to i64
  %iop_tmp374 = add i64 %iop_tmp371, %sext_cast373
  %t_byte_off378 = shl i64 %iop_tmp374, 2
  %t_ptr_i8379 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off378
  store float %d0, ptr addrspace(1) %t_ptr_i8379, align 4
  %iop_tmp389 = or disjoint i32 %iop_tmp360, 1
  %sext_cast390 = sext i32 %iop_tmp389 to i64
  %iop_tmp391 = add i64 %iop_tmp371, %sext_cast390
  %t_byte_off395 = shl i64 %iop_tmp391, 2
  %t_ptr_i8396 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off395
  store float %d1, ptr addrspace(1) %t_ptr_i8396, align 4
  %iop_tmp405 = mul i64 %25, %sext_cast81
  %iop_tmp408 = add i64 %iop_tmp405, %sext_cast373
  %t_byte_off412 = shl i64 %iop_tmp408, 2
  %t_ptr_i8413 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off412
  store float %d2, ptr addrspace(1) %t_ptr_i8413, align 4
  %iop_tmp426 = add i64 %iop_tmp405, %sext_cast390
  %t_byte_off430 = shl i64 %iop_tmp426, 2
  %t_ptr_i8431 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off430
  store float %d3, ptr addrspace(1) %t_ptr_i8431, align 4
  %subgrouplocalinvocationid435 = load i32, ptr addrspace(1) @__spirv_BuiltInSubgroupLocalInvocationId, align 4
  %iop_tmp438 = sdiv i32 %subgrouplocalinvocationid435, 4
  %27 = shl i32 %iop_tmp438, 3
  %28 = shl i32 %subgrouplocalinvocationid435, 1
  %iop_tmp448 = sub i32 %28, %27
  %iop_tmp454 = add i32 %iop_tmp448, 8
  %sext_cast459 = sext i32 %iop_tmp438 to i64
  %iop_tmp463 = mul i64 %25, %sext_cast459
  %sext_cast465 = sext i32 %iop_tmp454 to i64
  %iop_tmp466 = add i64 %iop_tmp463, %sext_cast465
  %t_byte_off470 = shl i64 %iop_tmp466, 2
  %t_ptr_i8471 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off470
  store float %d0338, ptr addrspace(1) %t_ptr_i8471, align 4
  %iop_tmp482 = add i32 %iop_tmp448, 9
  %sext_cast483 = sext i32 %iop_tmp482 to i64
  %iop_tmp484 = add i64 %iop_tmp463, %sext_cast483
  %t_byte_off488 = shl i64 %iop_tmp484, 2
  %t_ptr_i8489 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off488
  store float %d1340, ptr addrspace(1) %t_ptr_i8489, align 4
  %iop_tmp494 = add nsw i32 %iop_tmp438, 8
  %sext_cast495 = sext i32 %iop_tmp494 to i64
  %iop_tmp499 = mul i64 %25, %sext_cast495
  %iop_tmp502 = add i64 %iop_tmp499, %sext_cast465
  %t_byte_off506 = shl i64 %iop_tmp502, 2
  %t_ptr_i8507 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off506
  store float %d2342, ptr addrspace(1) %t_ptr_i8507, align 4
  %iop_tmp521 = add i64 %iop_tmp499, %sext_cast483
  %t_byte_off525 = shl i64 %iop_tmp521, 2
  %t_ptr_i8526 = getelementptr inbounds i8, ptr addrspace(1) %18, i64 %t_byte_off525
  store float %d3344, ptr addrspace(1) %t_ptr_i8526, align 4
  ret void
}
