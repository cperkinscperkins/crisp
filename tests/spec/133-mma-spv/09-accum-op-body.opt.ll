; ModuleID = 'C:/Users/cperk/Documents/crisp-man/tests/spec/133-mma-spv/09-accum-op-body.temp.ll'
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @parent__cell_int_global(ptr addrspace(1) %0, i64 %1, i64 %2) local_unnamed_addr #0 {
entry:
  ...
  ret %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @_parent__cell_int_global(ptr addrspace(1) %0, i64 %1, i64 %2) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @parent__tensor_float_2_global_compact_last(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @_parent__tensor_float_2_global_compact_last(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @parent__tensor_float_2_global_compact_first(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define spir_func %S_09_accum_op_body_STORAGE_GLOBAL @_parent__tensor_float_2_global_compact_first(ptr addrspace(1) %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
entry:
  %ADDRESS_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL undef, ptr addrspace(1) %0, 0
  %BYTE-SIZE_ins = insertvalue %S_09_accum_op_body_STORAGE_GLOBAL %ADDRESS_ins, i64 %1, 1
  ret %S_09_accum_op_body_STORAGE_GLOBAL %BYTE-SIZE_ins
...
entry:
  ...
  %t_elem158 = load i32, ptr addrspace(1) %t_ptr_i8, align 4, !invariant.load !5
  ...
  %t_elem94159 = load i32, ptr addrspace(1) %t_ptr_i893, align 4, !invariant.load !5
  ...
  %t_elem110160 = load i32, ptr addrspace(1) %t_ptr_i8109, align 4, !invariant.load !5
  ...
  %t_elem127161 = load i32, ptr addrspace(1) %t_ptr_i8126, align 4, !invariant.load !5
  ...
  %t_elem162162 = load i32, ptr addrspace(1) %t_ptr_i8161, align 4, !invariant.load !5
  ...
  %t_elem178163 = load i32, ptr addrspace(1) %t_ptr_i8177, align 4, !invariant.load !5
  %mma = tail call { float, float, float, float } @llvm.nvvm.mma.m16n8k8.row.col.tf32(i32 %t_elem158, i32 %t_elem94159, i32 %t_elem110160, i32 %t_elem127161, i32 %t_elem162162, i32 %t_elem178163, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00)
  ...
  %mma337 = tail call { float, float, float, float } @llvm.nvvm.mma.m16n8k8.row.col.tf32(i32 %t_elem158, i32 %t_elem94159, i32 %t_elem110160, i32 %t_elem127161, i32 %t_elem162162, i32 %t_elem178163, float %d0, float %d1, float %d2, float %d3)
  ...
  store float %d0338, ptr addrspace(1) %t_ptr_i8379, align 4
  ...
  store float %d1340, ptr addrspace(1) %t_ptr_i8396, align 4
  ...
  store float %d2342, ptr addrspace(1) %t_ptr_i8413, align 4
  ...
  store float %d3344, ptr addrspace(1) %t_ptr_i8431, align 4
  ret void
}
